...
from . import engine
from parser import _nav, _parse_float, _parse_datetime, _parse_boolean
...
#######
### Autogenerated models for model.py created on 2013-02-05 01:07:35.932787
#######
...
class ActivityDate(Base):
    ...
    iso_date = Column(UnicodeText)	# @iso-date
    lang = Column(UnicodeText)	# @xml:lang
    @classmethod
    def _parse_xml(cls,logger,xml):
        data = {}
        ...
        data['iso_date'] = _nav(logger, xml, [], attrib='iso-date')
        data['lang'] = _nav(logger, xml, [], attrib='xml:lang')
