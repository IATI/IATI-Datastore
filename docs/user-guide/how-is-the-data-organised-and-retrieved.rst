...
Each activity reported in IATI-XML format is stored as a unique record in an Activities Table. In IATI terminology an “activity” can be a project, programme, grant or any other user-defined unit of aid. The data store uses the <iati-identifier> element as the key to defining a unique record.
